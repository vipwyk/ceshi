...
public class FayouJian {
    ...
    public static String myEmailAccount = "vipwyk0506@163.com";
    public static String myEmailPassword = "asd1234567";

    // 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
    // 网易163邮箱的 SMTP 服务器地址为: smtp.163.com
    public static String myEmailSMTPHost = "smtp.163.com";
    public static  String attachedFileName="D:\\QQ\\1121176445\\FileRecv\\nk.txt";
    private  static String htmlContent="zhengwem";
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "1121176445@qq.com";
...
//        message.setContent("jjkk", "text/html;charset=UTF-8");      
         // 6. 设置发件时间
