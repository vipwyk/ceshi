...
public class ceshiEleven extends BaseTest{
		
		@Test(priority=1)
		public void one() throws InterruptedException{
			System.out.println("打印第36个测试用例");
...
//			webtest.click("xpath=//input[contains(@xname,'联想显示器')]");
//			webtest.click("xpath=//input[@value='确定']");
//			webtest.typeAndClear("name=count0_0", "1");							
			webtest.click("id=AltS");
			webtest.refresh();
